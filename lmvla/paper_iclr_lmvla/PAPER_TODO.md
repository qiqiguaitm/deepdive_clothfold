...
tree reached 8.6 GiB at 06:30 UTC and continued to grow, so the transfer is
...
- [ ] **TG1A-E1 [RUNNING-RUNTIME-V10: `t-20260808110854-xxb97`; prior failed
  ...
  then completed `blocks_ranking_rgb`. Eval seed 1 subsequently completed the
  same RGB task, producing 9/24 summaries at 06:24 UTC. The final exact-24-cell
