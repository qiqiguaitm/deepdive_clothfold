...
The utility gate is accepted.  P4 repeats the normal--shuffled, zero-route, and
...
content-specific causality or independent baseline-seed replication.  The
canonical records are
\texttt{RESULTS\_pi05\_predictive\_adapter\_p2\_gate.json} and
\texttt{RESULTS\_pi05\_predictive\_adapter\_p2\_efficiency.json}.
