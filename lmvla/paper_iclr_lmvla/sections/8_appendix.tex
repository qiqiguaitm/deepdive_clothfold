...
The utility gate is accepted.  Because P2 does not repeat the normal--shuffled
intervention and holds the A0 training seed fixed, this result establishes
candidate-seed replication relative to that A0, not content-specific causality
or independent baseline-seed replication.  The canonical records are
