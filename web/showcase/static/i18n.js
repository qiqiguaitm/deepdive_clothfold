...
const I18N = {
  zh: {
    ...
    mint_entry_title:  "MINT-VLA：可预测未来不等于控制收益",
    mint_entry_desc:   "最终证据报告：三种子 MINT 负结果、predictive adapter 独立 matched-seed 失败、内容干预与成熟基线对照，以及冻结停止规则。",
    mint_entry_action: "查看最终证据报告",
  ...
  en: {
    ...
    tab_docs:         "Docs",
    tab_mint:         "MINT-VLA evidence report",
    ...
    mint_entry_title:  "MINT-VLA: predictable futures do not ensure control utility",
    mint_entry_desc:   "Final evidence report covering the three-seed MINT result, independently matched predictive-adapter replication, causal controls, mature-baseline comparison, and frozen stop rules.",
    mint_entry_action: "Open evidence report",
